...
<body class="d-flex flex-column">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #004aac;">
        ...
        <div class="form-inline my-2 my-lg-0">
            <a href="<?php echo base_url('/cadastro'); ?>"><button class="btn btn-secondary mr-sm-2" type=""> Cadastre-se </button></a>
            <a href="<?php echo base_url('/usuario'); ?>"><button class="btn btn-primary my-2 my-sm-0" type="">Login</button></a>
        </div>
        </div>
    </nav>
